...
const RESSOURCES: IRessource[] = [
  {
    ...
    permissions: [
      ...
      { name: 'validate', slug: Permission.USER.VALIDATE },
  ...
  },
  {
    name: 'airtel',
    permissions: [
      { name: 'check-kyc', slug: Permission.AIRTEL.CHECK_KYC },
    ],
  },
  {
    name: 'transaction',
    permissions: [
      { name: 'read', slug: Permission.TRANSACTION.READ },
      { name: 'read-own-transactions', slug: Permission.TRANSACTION.READ_OWN_TRANSACTIONS },
      ...
      { name: 'create-with-own-account', slug: Permission.TRANSACTION.CREATE_WITH_OWN_ACCOOUNT },
      ...
      { name: 'read-transaction-to-validate-at-bank-level', slug: Permission.TRANSACTION.READ_TRANSACTIONS_TO_VALIDATE_AT_BANK_LEVEL },
